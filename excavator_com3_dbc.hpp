...
#include "excavator_com3_struct.hpp"
...
class excavator_com3_dbc
{
public:
  excavator_com3_dbc(std::string dbc_path)
  {
    ...
    can_bus = std::make_shared<excavator_com3::Can_Bus>();
  }
...
private:
  ...
  std::shared_ptr<excavator_com3::Can_Bus> can_bus;
};